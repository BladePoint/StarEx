...
package starEx.text {
	...
	/* A TextFormatEx stores formatting information such as the font, size, and colors of each corner and outline for a TextFieldEx.
	   Much of this code is appropriated from starling.text.Textformat. */
	public class TextFormatEx extends EventDispatcher {
		...
		public function setDropShadowPosition(newX:Number,newY:Number):void {
			_dropShadowX = newX;
			_dropShadowY = newY;
			dispatch(SHADOW_CHANGE,0xff0000);
		}
